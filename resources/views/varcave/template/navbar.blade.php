<nav class="navbar" role="navigation" aria-label="main navigation">
  ...
  <div class="navbar-brand">
    <a class="navbar-item" href="{{route('varcave.home')}}">
  ...
  <div id="navbarBasic" class="navbar-menu">
    <div class="navbar-start">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        <a class="navbar-link">
          {{__('varcave.navbar.more')}}
        </a>

        <div class="navbar-dropdown">
          <a class="navbar-item" href="/servers">
            {{__('varcave.navbar.servers')}}
          </a>
          <!--<a class="navbar-item">
            Show configs
          </a>-->
          <a class="navbar-item" href="/settings">
            {{__('varcave.navbar.settings')}}
          </a>
        </div>
      </div>
      @endauth
    ...
    <div class="navbar-end">
        {{-- theme menu changer --}}
          <div class="navbar-item has-dropdown is-hoverable">
            <a id="theme-changer" class="navbar-link" data-targeturl="{{route('myaccount.setTheme',['theme'=>'#'])}}">
              <span class="icon">
          ...
          <div class="navbar-item has-dropdown is-hoverable mr-2">
            ...
            <div class="navbar-dropdown is-right">
              <a class="navbar-item" href="/myaccount"> {{__('varcave.navbar.account')}} </a>
